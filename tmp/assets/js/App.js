...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* Already existing in node_modules when we npm install jquery --save-dev */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Modal = function () {
		function Modal() {
			...
			this.openModalButton = (0, _jquery2.default)(".open-modal"); /* CTA button for Modal */
			this.modal = (0, _jquery2.default)(".modal"); /* Main modal div to reveal */
			this.closeModalButton = (0, _jquery2.default)(".modal__close"); /* X - close button */
